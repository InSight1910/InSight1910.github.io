...
import LanguageContext from "../navbar/Navbar.jsx";
import "./Home.css";
...
export const Home = () => {
	const data = {
		en: {
			...
			description:
				"I'm a junior web developer with a passion of create amazing website",
			button: "Contact Me",
		},
	};
						...
						<div className="bio__group">
							...
							<div className="bio__data">
								...
								<p className="home__description">
									I'm a junior web developer with a passion of
